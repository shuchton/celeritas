...
func (h *Handlers) PostForm(w http.ResponseWriter, r *http.Request) {
	...
	validator.Check(len(r.Form.Get("first_name")) > 1, "first_name", "Must have at least 2 characters")
	validator.Check(len(r.Form.Get("last_name")) > 1, "last_name", "Must have at least 2 characters")
